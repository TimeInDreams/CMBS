...
import PreLoad.vggish_input as vggish_input
import PreLoad.vggish_params as vggish_params
import PreLoad.vggish_slim as vggish_slim
import h5py
...
def audio_feature_extract(audio_dir):
    ...
    for n in range(len_data):
        ...
        with tf.Graph().as_default(), tf.compat.v1.Session() as sess:
            ...
            # print('tensor_shape:',embedding_tensor.shape)
